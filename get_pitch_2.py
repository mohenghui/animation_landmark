...
if __name__ == '__main__':
    ...
    for idx, img in enumerate(img_list):
        ...
        circle_to_browfoot=sign_cal_distance(landmark_info[2],landmark_info[1])
        noisefoot_to_chin=sign_cal_distance(landmark_info[4],landmark_info[0])
        max_distance=max(abs(circle_to_browfoot),abs(noisefoot_to_chin))
        cv2.line(og_img, beint(landmark_info[2]), beint(
        landmark_info[1]), (77, 22, 55), 1)
